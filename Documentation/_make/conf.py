# -*- coding: utf-8 -*-
#
# Atlassian HipChat Notification & API Services documentation build configuration file, created by
# TYPO3 extension sphinx on Sat, 03 May 2014 07:01:59 +0000.
#
...
project = u'Atlassian HipChat Notification & API Services'
copyright = u'2014, mehrwert'
...
latex_documents = [
    ('Index', 'hipchat.tex', u'Atlassian HipChat Notification & API Services',
     u'mehrwert', 'manual'),
]
...
pdf_documents = [
    ('Index', 'hipchat', u'Atlassian HipChat Notification & API Services',
     u'mehrwert'),
]
...
texinfo_documents = [
    ('Index', 'hipchat', u'Atlassian HipChat Notification & API Services',
     u'mehrwert', 'Atlassian HipChat Notification & API Services', 'One line description of project.',
     'Miscellaneous'),
]
